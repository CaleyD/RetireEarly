// TODO: do not enable deletion of first income period
...
// TODO: align dollar amounts vertically centered
        ...
        </TouchableHighlight>
        {
          [
            ...
            <View style={[styles.progressRowColumn, {alignItems: 'stretch'}]} key={item.field}>
              <SidebarInputTrigger value={rowData[item.field]} sidebarInput={sidebarInput}
                onChange={(num)=>{
                  var attrs = {};
  ...
  renderInitialPortfolioValueRow() {
    ...
    return (
      <View style={{backgroundColor: '#fff', borderTopColor: '#ccc', borderTopWidth: 1}}>
        <ProgressRow year={0}>
          <SidebarInputTrigger sidebarInput={sidebarInput}
