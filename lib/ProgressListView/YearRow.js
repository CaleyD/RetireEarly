...
export default class YearRow extends Component {
  ...
  render() {
    ...
    return (
      <View style={[styles.progressRow, {height: 44, backgroundColor: '#999'}]}>
        ...
        <Text style={[styles.progressRowAmount, {backgroundColor: 'transparent'}]}>{formatMoney(portfolioValue)}</Text>
      </View>
    );
  }
}
