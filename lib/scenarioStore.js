...
class ScenarioStore extends EventEmitter {
  ...
  insertIncomePeriod(atYearIndex) {
    var newIncomePeriod = {};
    ...
    newIncomePeriod.annualSpending = previousIncomePeriod.annualSpending;
    newIncomePeriod.annualIncome = previousIncomePeriod.annualIncome;
