...
var Row = React.createClass({
  ...
  render: function() {
    ...
    //throw new Error(this.props.rowData.index)
    let shouldDisplayHovering = activeIndex !== this.props.rowData.index &&
      // do not allow user to place before another period
      (this.props.rowData.data.type != 'period' || this.props.rowData.data == activeData) &&
      // or before the first year after a period
      (this.props.list.props.data[this.props.list.props.order[this.props.list.props.order.indexOf(this.props.rowData.index)-1]].type!='period' ||
      this.props.list.props.data[this.props.list.props.order[this.props.list.props.order.indexOf(this.props.rowData.index)-1]] == activeData);
