...
import { showEditPeriod } from '../../../reducers/ui.js';
        ...
        {[{title: 'Income', propName: 'income'},
          {title: 'Expenses', propName: 'expenses'}
            ...
            <View style={styles.progressRowColumn} key={propName}>
              <TouchableOpacity onPress={()=>showEditPeriod({yearIndex, propName})}>
                <View style={styles.progressRowColumn}>
                  <Text style={styles.incomeExpenseLabel}>{title}</Text>
                  <Text style={styles.incomeExpenseValue}>{formatMoney(period[propName])}</Text>
                </View>
              </TouchableOpacity>
            </View>
          ))
