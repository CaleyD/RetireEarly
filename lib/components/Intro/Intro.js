...
class Intro extends Component {
  ...
  continue() {
    ...
    const { setInitialPortfolio, editPeriod, firstIncomePeriod, navigateToHome } = this.props;
...
export default connect(
  ({ scenario }) => ({ firstIncomePeriod: scenario.incomePeriods[0] }),
  {
    setInitialPortfolio,
    editPeriod,
    navigateToHome: () => navigatePush({key: 'Home', title: 'Retire Early', hideHeader: true})
  }
)(Intro);
