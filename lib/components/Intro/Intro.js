...
const styles = StyleSheet.create({
  ...
  slide2: { ...slide, backgroundColor: 'orange' },
  slide3: { ...slide, backgroundColor: 'green' },
  slide4: { ...slide, backgroundColor: 'purple' },
  text: {
    color: '#fff',
    fontSize: 30,
    fontWeight: 'bold',
...
class Intro extends Component {
          ...
          <InputSlide title="What is your current annual income?"
            ...
            descriptionControls={
              <Text>
                ...
                Be sure to include any contributions to retirement accounts
  ...
  continue () {
    ...
    const {
      setInitialPortfolio, editPeriod, firstIncomePeriod, navigateToHome
    } = this.props;
...
export default connect(
  ({ scenario }) => ({ firstIncomePeriod: scenario.incomePeriods[0] }),
  {
    setInitialPortfolio,
    editPeriod,
    navigateToHome: () => navigateReset(
      [{key: 'Home', title: 'Retire Early'}], 0)
  }
)(Intro);
