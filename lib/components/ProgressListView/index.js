...
import {
  movePeriod, setInitialPortfolio, addPeriod, deletePeriod, editPeriod
...
class Progress extends Component {
  ...
  render() {
    const {
      scenario, outlook, hideDeleteAndReorder, onInitialPortfolioChange,
      onMovePeriod, onAddPeriod, onEditPeriod, onDeletePeriod
    } = this.props;
          ...
          if(rowData.type === 'year') {
            ...
            return (
              <IncomeExpenseRow {...rowData}
                ...
                onEditPeriod={onEditPeriod} onDeletePeriod={onDeletePeriod}
  ...
  onRowMoved(e) {
    ...
    setImmediate(()=>{
      this._source = null;
      onMovePeriod(period, targetYear);//destination-1))
    });
  }
}
Progress.propTypes = {
