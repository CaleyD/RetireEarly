  ...
  constructor(props) {
    ...
    this.onLayout = e => {
      ...
      const sliderStyle = {
        ...
        marginLeft: -.5 * layout.height + 40,
        marginTop: layout.height * .5 - 20
      };
  ...
  render() {
    return (
      <View style={styles.verticalSliderContainer}
        ...
        <TouchableOpacity onPress={this.selectRange}>
...
class QuickDollarInputSidebar extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
...
function SideBarContainer(props) {
  return (
    <View style={styles.container}>
      {props.children}
      <QuickDollarInputSidebar onVisibilityChange={props.onVisibilityChange} />
    </View>
  );
}
